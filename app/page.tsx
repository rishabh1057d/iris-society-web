        ...
        >
          ...
          */}
          ...
          <ResponsiveContainer size="lg" padding="lg" className="relative z-10">
            ...
            >
              {/* Logo glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-[#3230e0]/25 to-[#5b59f0]/20 blur-2xl scale-110 opacity-60" />
            ...
            >
              ...
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-full" />
            </motion.h1>
            ...
            >
              ...
              >
                {/* Button glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-lg blur-lg opacity-75 group-hover:opacity-100 transition-opacity duration-300 scale-110" />
                <button 
                  onClick={handleJoinNowClick} 
                  className="relative btn-primary w-full sm:w-auto px-8 py-4 text-lg font-bold shadow-2xl group-hover:shadow-[#3230e0]/30 transition-all duration-300" 
              ...
              >
                <button
                  ...
                  className="relative w-full sm:w-auto px-8 py-4 text-lg font-bold rounded-lg border-2 border-[#3230e0]/55 text-[#a8a6ff] bg-transparent hover:bg-[#3230e0]/10 hover:border-[#3230e0] transition-all duration-300 shadow-lg hover:shadow-[#3230e0]/30 backdrop-blur-sm"
                >
        ...
        {videoData?.enabled && (
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
              <div className="absolute w-72 h-72 rounded-full bg-gradient-to-r from-[#3230e0]/08 to-[#5b59f0]/06 blur-3xl top-1/4 left-1/4 animate-pulse" />
              <div className="absolute w-64 h-64 rounded-full bg-gradient-to-r from-[#3230e0]/07 to-[#5b59f0]/05 blur-3xl bottom-1/4 right-1/4 animate-pulse" style={{ animationDelay: '3s' }} />
            </div>
            ...
            <ResponsiveContainer size="xl" padding="lg" className="py-12 md:py-24">
              ...
              >
                ...
                >
                  ...
                  {/* Decorative underline */}
                  <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-full" />
                </motion.h2>
              ...
              >
                ...
                <div className="relative glass-card p-2 md:p-6 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-[#3230e0]/15 via-[#5b59f0]/12 to-[#3230e0]/15 rounded-xl blur-sm" />
          ...
          <ResponsiveContainer size="xl" padding="lg" className="py-12 md:py-24">
            ...
            >
              ...
              >
                ...
                {/* Decorative underline */}
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-full" />
              </motion.h2>
              ...
              <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
                ...
                >
                  <div className="relative glass-card p-6 md:p-8 overflow-hidden">
                    {/* Decorative border gradient */}
                    <div className="absolute inset-0 bg-gradient-to-r from-[#3230e0]/10 via-[#5b59f0]/08 to-[#3230e0]/10 rounded-xl blur-sm" />
                    <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-6 md:p-8">
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Decorative underline */}
                          <div className="absolute -bottom-1 left-0 w-16 h-0.5 bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-full" />
                        </h3>
                      </motion.div>
                      ...
                      >
                        ...
                        >
                          ...
                          <Link 
                            href="/potw" 
                            className="relative btn-primary inline-block w-full sm:w-auto text-center px-8 py-3 text-lg font-bold shadow-2xl group-hover:shadow-[#3230e0]/30 transition-all duration-300"
                          >
                            <span className="relative z-10 flex items-center justify-center gap-2">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
