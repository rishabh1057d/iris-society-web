...
export default function AboutClientPage() {
  ...
  return (
    <section className="flex min-h-screen flex-col items-center relative">
        ...
        <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <p className="text-gray-300 mb-4">
              Founded in November 2023, IRIS Society is the official Photography and Videography Society of IIT Madras BS
              Degree program. We are a passionate community of visual storytellers dedicated to capturing moments,
              crafting narratives, and expressing creativity through both photography and videography.
            </p>
            <p className="text-gray-300 mb-6">
              What began as a photography club has grown into a vibrant creative society that celebrates the power of
              both still and moving images. Whether you are just starting out or already experienced in the field, IRIS
              offers a welcoming space to learn, explore, and grow your craft. At IRIS, we believe that visual media is
              more than just an art form. It is a language that allows us to see the world differently, share unique
              perspectives, and tell stories that inspire and connect.
            </p>
            ...
            >
              {["Workshops", "Monthly Competitions", "Photowalks", "Collaborations"].map((activity, index) => (
                <motion.li
                  key={index}
