  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[9999] bg-gradient-to-br from-[#0F1013] via-[#16182a] to-[#0F1013] flex items-center justify-center"
      >
        {/* Background Pattern */}
        ...
        <div className="relative z-10 text-center max-w-md mx-auto px-6">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="w-20 h-20 mx-auto bg-gradient-to-br from-[#3230e0] to-[#5b59f0] rounded-full flex items-center justify-center shadow-2xl">
              <motion.div
                animate={{ rotate: 360 }}
          ...
          <div className="w-full bg-slate-700/50 rounded-full h-3 mb-6 overflow-hidden">
            <motion.div
              className="h-full bg-gradient-to-r from-[#3230e0] to-[#5b59f0] rounded-full shadow-lg"
              initial={{ width: 0 }}
          ...
          <motion.div
            ...
            className="text-[#a8a6ff] font-semibold text-sm"
          >
            {Math.round(progress)}%
          </motion.div>
